...
from cysecuretools.prepare.provisioning_lib.cyprov_hsm import HsmEntity
from cysecuretools.prepare.provisioning_lib.cyprov_oem import OemEntity
from cysecuretools.prepare.provisioning_lib.cyprov_customer import CustomerEntity
...
def main(oem_state_path, hsm_state_path, image_cert, cy_auth_path,
    ...
    if len(cust_key_path) > CUSTOMER_KEY_N:
        raise ValueError('Maximum number of customer keys must be {}!'.format(CUSTOMER_KEY_N))
