...
"""
import os
from cysecuretools.execute.gen_data_from_json import ENTRANCE_EXAM_SRAM_ADDR, ENTRANCE_EXAM_SRAM_SIZE, ENTRANCE_EXAM_FW_STATUS_REG
from cysecuretools.execute.p6_reg import CYREG_IPC2_STRUCT_ACQUIRE, CYREG_IPC2_STRUCT_DATA, CYREG_IPC2_STRUCT_NOTIFY, \
...
def transition_to_secure(tool, blow_secure_efuse):
    ...
    tool.write32(ENTRANCE_EXAM_SRAM_ADDR, (TRANSISION_TO_SECURE_OPCODE << 24) + (blowing_secure_value << 16))
    scratch_addr = ENTRANCE_EXAM_SRAM_ADDR + 0x08
    tool.write32(ENTRANCE_EXAM_SRAM_ADDR + 0x04, scratch_addr)
